...
#include "mongo/util/concurrency/optimistic_rwlock.h"
...
namespace PerfTests {
    ...
    */
    ...
    OptimisticShareableLock optimistic;
    SimpleRWLock simplerw("testsimple");
    RWLock lk("testrw");
    ...
    public:
        string name() { return "boost::condition::notify_one"; }
    ...
    public:
        string name() { return "mongo::mutex"; }
        virtual int howLongMillis() { return 500; }
        virtual bool showDurStats() { return false; }
        void timed() {
    ...
    public:
        string name() { return "mongo::SimpleMutex"; }
        virtual int howLongMillis() { return 500; }
        virtual bool showDurStats() { return false; }
        void timed() {
    ...
    public:
        string name() { return "mongo::SpinLock"; }
        virtual int howLongMillis() { return 500; }
        virtual bool showDurStats() { return false; }
        void timed() {
...
#define RUNCOMPARESWAP 1
    ...
    public:
        string name() { return "RWLock::lock_shared"; }
        virtual int howLongMillis() { return 500; }
        virtual bool showDurStats() { return false; }
        void timed() {
            lk.lock_shared();
    ...
    public:
        string name() { return "RWLock::lock"; }
        virtual int howLongMillis() { return 500; }
        virtual bool showDurStats() { return false; }
        void timed() {
            lk.lock();
    ...
    class rlocko : public B {
    public:
        string name() { return "OptimimsticShareableLock::lock_shared"; }
        virtual int howLongMillis() { return 500; }
        virtual bool showDurStats() { return false; }
        void timed() {
            OptimisticShareableLock::Shared lk(optimistic);
        }
    };
    class wlocko : public B {
    public:
        string name() { return "OptimimsticShareableLock::lock"; }
        virtual int howLongMillis() { return 500; }
        virtual bool showDurStats() { return false; }
        void timed() {
            OptimisticShareableLock::Exclusive lk(optimistic);
        }
    };
    class simplerwlock : public B { 
    public:
        string name() { return "SimpleRWLock::lock"; }
        virtual int howLongMillis() { return 500; }
        virtual bool showDurStats() { return false; }
        void timed() {
            simplerw.lock();
    ...
    public:
        string name() { return "QLock::lock_r"; }
        //virtual int howLongMillis() { return 500; }
        virtual bool showDurStats() { return false; }
        void timed() {
            _qlock.lock_r();
    ...
    public:
        string name() { return "QLock::lock_w"; }
        //virtual int howLongMillis() { return 500; }
        virtual bool showDurStats() { return false; }
        void timed() {
            _qlock.lock_w();
    ...
    public:
        string name() { return "QLock::lockAsUpgradable"; }
        virtual int howLongMillis() { return 500; }
        virtual bool showDurStats() { return false; }
        void timed() {
            lk.lockAsUpgradable();
